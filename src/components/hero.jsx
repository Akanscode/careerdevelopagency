...
const HeroSection = () => {
  return (
      <section>
          <div aria-hidden="true" className="absolute inset-0 my-auto w-96 h-32 rotate-45 bg-gradient-to-r from-pink-500 to-pink-600 blur-3xl opacity-50"></div>
                      ...
                      <div className="relative flex flex-col items-center text-center lg:text-left lg:py-7 xl:py-8 lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
                          ...
                          <div className="mt-10  w-full flex max-w-md mx-auto lg:mx-0">
                              <div className="flex sm:flex-row flex-col gap-5 w-full">
                                  <form action="#" className="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-gray-600 shadow-lg shadow-gray-200/20 border border-gray-200 bg-gray-100 rounded-full ease-linear focus-within:bg-white  focus-within:border-blue-600">
                                      <span className="min-w-max pr-2 border-r border-gray-200">
                                          ...
                                          >
                                              ...
                                              d="M21.75 9v.906a2.25 2.25 0 01-1.183 1.981l-6.478 3.488M2.25 9v.906a2.25 2.25 0 001.183 
                                              1.981l6.478 3.488m8.839 2.51l-4.66-2.51m0 0l-1.023-.55a2.25 2.25 0
                          ...
                          <div className=' mt-12 flex gap-6 lg:gap-12 justify-between'>
                                  <FaFacebook className=' w-auto h-8 sm:h-10 lg:h-12 text-blue-800' />
                                  <FaLinkedin className=' w-auto h-8 sm:h-10 lg:h-12 text-blue-800'/>
                                  <SiUpwork className=' w-auto h-8 sm:h-10 lg:h-12 text-green-800' />
                                  <SiFiverr className=' w-auto h-8 sm:h-10 lg:h-12 text-green-800'/>
                                  
                              </div>
                      </div>
                      <div className="flex flex-1 lg:w-1/2  relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
                          <img src="/assests/images/heroimage.webp"
                              alt="Heroimage"
                              width={500}
                              height={500}
                              className="lg:absolute  rounded-3xl object-cover" 
